...
$ http POST $BASE_ADDR/pulp/api/v3/publications/chart/chart/ name=bar

Response::

    {
        "pulp_href": "http://localhost:24817/pulp/api/v3/publications/chart/chart/bar/",
        ...
    }
...
$ http POST $BASE_ADDR/pulp/api/v3/distributions/chart/chart/ name='baz' base_path='foo' publication=$BASE_ADDR/publications/5fcb3a98-1bd1-445f-af94-801a1d563b9f/
