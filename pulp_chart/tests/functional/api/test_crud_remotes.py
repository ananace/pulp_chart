# coding=utf-8
"""Tests that CRUD chart remotes."""
from random import choice
import unittest

from pulp_smash import utils

from pulp_chart.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_chart import RemotesChartApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesChartApi(gen_chart_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesChartApi(gen_chart_client()).create(body)
