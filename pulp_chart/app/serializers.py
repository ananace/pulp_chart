...
class ChartContentSerializer(platform.SingleArtifactContentSerializer):
    ...
    Add serializers for the new fields defined in ChartContent and
...
class ChartRemoteSerializer(platform.RemoteSerializer):
    """
    A Serializer for ChartRemote.

    Add any new fields if defined on ChartRemote.
    Similar to the example above, in ChartContentSerializer.
...
class ChartRepositorySerializer(platform.RepositorySerializer):
    """
    A Serializer for ChartRepository.

    Add any new fields if defined on ChartRepository.
    Similar to the example above, in ChartContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.ChartRepository


class ChartPublicationSerializer(platform.PublicationSerializer):
    """
    A Serializer for ChartPublication.

    Add any new fields if defined on ChartPublication.
    Similar to the example above, in ChartContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.ChartPublication


class ChartDistributionSerializer(platform.PublicationDistributionSerializer):
    """
    A Serializer for ChartDistribution.

    Add any new fields if defined on ChartDistribution.
    Similar to the example above, in ChartContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.ChartDistribution
